...
public class Directions extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map))
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                if (factoids != null) {
                    searchFor(marker.getTitle());
                }
            }
        });
    }

    private ArrayList<String> findFactoids(String title) {
    ...
    public void search(View v) {
        EditText searched = (EditText) findViewById(R.id.editText);
        searchFor(searched.getText().toString());
    }

    private void searchFor(String toPosition) {
        if (toPosition.length() != 0) {
            Intent i = new Intent(Intent.ACTION_VIEW,
                    Uri.parse("google.navigation:q=" + toPosition));
            startActivity(i);
        }
    }
